...
1. Controlla [ARCHITETTURA-GUIDA.md](ARCHITETTURA-GUIDA.md) per spiegazioni sulla progettazione
2. Rivedi [QUICK-REFERENCE.md](QUICK-REFERENCE.md) per i parametri degli endpoint
3. Vedi [guide.md](guide.md) per la risoluzione dei problemi di setup
4. Testa con `test-curl-collection.sh` per una rapida convalida

---

## 📄 Licenza

Questo progetto fa parte di un'assegnazione scolastica (TPS - Tecnica Pratica Scolastica - Quinto Anno).
```json
{
  "utente_id": 1,
  "obiettivo": "massa",
